...
background_img = pygame.image.load(os.path.join("pics", "background.jpg"))
background = pygame.transform.scale(background_img, (width,height))
cross_img = pygame.image.load(os.path.join("pics", "X.jpg"))
cross = pygame.transform.scale(cross_img, (140,140))
zero_img = pygame.image.load(os.path.join("pics", "O.jpg"))
zero = pygame.transform.scale(zero_img, (140,140))
win_screenXimg = pygame.image.load(os.path.join("pics", "cross_win.jpg"))
win_screenX = pygame.transform.scale(win_screenXimg, (450,450))
win_screenOimg = pygame.image.load(os.path.join("pics", "circle_win.jpg"))
win_screenO = pygame.transform.scale(win_screenOimg, (450,450))
draw_screen_img = pygame.image.load(os.path.join("pics", "Draw.jpg"))
